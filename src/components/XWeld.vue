      ...
      <div class="d-flex flex-column w-100 h-100 align-end" style="padding: 10px 0 0 80px;">
        ...
        <div class="w-100 mt-4 d-flex justify-space-between">
            <div class="kuka-menu d-flex flex-column w-100 pt-2 rounded align-center justify-space-between" :style="{backgroundColor: kukaColor2}">
              ...
              <v-text-field v-model="kukaWFR" class="w-75 mt-3" clearable density="comfortable" label="Weld Feed Rate (mm/sec)"></v-text-field>
              <v-text-field v-model="kukaIFR" class="w-75" clearable density="comfortable" label="Idle Feed Rate (mm/sec)"></v-text-field>
              <div class="d-flex justify-space-between w-75">
                <v-text-field v-model="kukaUF" class="mr-5" density="comfortable" label="UF:"></v-text-field>
                <v-text-field v-model="kukaUT" density="comfortable" label="UT:"></v-text-field>
              </div>
              <v-select
                class="w-75" density="comfortable"
            ...
            <div class="kuka-menu d-flex flex-column w-100 mx-4 pt-2 rounded align-center justify-space-between" :style="{backgroundColor: kukaColor2}">
              <div class="text-subtitle-1 font-weight-bold" style="cursor: default;">Oscillation Parameters</div>
                <v-select
                  class="w-75 mt-3" density="comfortable"
                  label="Oscillation Function" v-model="kukaOFunc"
                  :items="['Var', 'Var']"
                ></v-select>
                <v-text-field v-model="kukaXAmp" class="w-75" clearable density="comfortable" label="X Amplitude (mm)"></v-text-field>
                <v-text-field v-model="kukaYAmp" class="w-75" clearable density="comfortable" label="Y Amplitude (mm)"></v-text-field>
                <v-text-field v-model="kukaDisc" class="w-75" clearable density="comfortable" label="Discretization (pcs)"></v-text-field>
            </div>
            <div class="kuka-menu d-flex flex-column w-100 mr-4 pt-2 rounded align-center justify-space-between" :style="{backgroundColor: kukaColor2}">
              ...
              <v-text-field v-model="kukaLayerHeight" class="w-75 mt-3" clearable density="comfortable" label="Layer Height (mm)"></v-text-field>
              <v-text-field v-model="kukaMinMoveLen" class="w-75" clearable density="comfortable" label="Minimum Move Length (mm)"></v-text-field>
              <v-text-field v-model="kukaMaxSplineLen" class="w-75" clearable density="comfortable" label="Maximum Spline Length (mm)"></v-text-field>
              <v-text-field v-model="kukaComLim" class="w-75" clearable density="comfortable" label="Commands Limit (mm)"></v-text-field>
            </div>
            <div class="kuka-menu d-flex flex-column w-100 pt-2 rounded align-center" :style="{backgroundColor: kukaColor2}">
              ...
              <div class="d-flex flex-column justify-space-between align-center mt-3">
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="kukaXZeroPos" class="w-100 mx-1" density="comfortable" label="X (mm)"></v-text-field>
                  <v-text-field v-model="kukaYZeroPos" class="w-100" density="comfortable" label="Y (mm)"></v-text-field>
                  <v-text-field v-model="kukaZZeroPos" class="w-100 mx-1" density="comfortable" label="Z (mm)"></v-text-field>
                </div>
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="kukaADeg" class="w-100 mx-1" density="comfortable" label="A (deg)"></v-text-field>
                  <v-text-field v-model="kukaBDeg" class="w-100" density="comfortable" label="B (deg)"></v-text-field>
                  <v-text-field v-model="kukaCDeg" class="w-100 mx-1" density="comfortable" label="C (deg)"></v-text-field>
                </div>
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="kukaE1" class="mx-1" density="comfortable" label="E1 (deg)"></v-text-field>
                  <v-text-field v-model="kukaE2" density="comfortable" label="E2 (deg)"></v-text-field>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="w-100 mt-4 d-flex justify-space-between">
            <div class="fanuc-menu d-flex flex-column w-100 pt-2 rounded align-center justify-start" :style="{backgroundColor: fanucColor2}">
              ...
              <div class="w-75 h-75 d-flex flex-column">
                <v-text-field v-model="fanucWFR" class="mt-3" clearable density="comfortable" label="Weld Feed Rate (mm/sec)"></v-text-field>
                <v-text-field v-model="fanucIFR" clearable density="comfortable" label="Idle Feed Rate (mm/sec)"></v-text-field>
                <div class="d-flex justify-space-between">
                  <v-text-field v-model="fanucUF" class="mr-5" density="comfortable" label="UF:"></v-text-field>
                  <v-text-field v-model="fanucUT" density="comfortable" label="UT:"></v-text-field>
              </div>
              </div>
            </div>
            <div class="fanuc-menu d-flex flex-column w-100 mx-4 pt-2 rounded align-center justify-space-between" :style="{backgroundColor: fanucColor2}">
              <div class="text-subtitle-1 font-weight-bold" style="cursor: default;">Oscillation Parameters</div>
                <v-select
                  ...
                  :items="['Var', 'Var']"
                ></v-select>
                <v-text-field v-model="fanucXAmp" class="w-75" clearable density="comfortable" label="X Amplitude (mm)"></v-text-field>
                <v-text-field v-model="fanucYAmp" class="w-75" clearable density="comfortable" label="Y Amplitude (mm)"></v-text-field>
                <v-text-field v-model="fanucDisc" class="w-75" clearable density="comfortable" label="Discretization (pcs)"></v-text-field>
            </div>
            <div class="fanuc-menu d-flex flex-column w-100 mr-4 pt-2 rounded align-center justify-start" :style="{backgroundColor: fanucColor2}">
              ...
              <div class="h-50 w-75 d-flex flex-column">
                <v-text-field v-model="fanucLayerHeight" class="mt-3" clearable density="comfortable" label="Layer Height (mm)"></v-text-field>
                <v-text-field v-model="fanucMinMoveLen" clearable density="comfortable" label="Minimum Move Length (mm)"></v-text-field>
              </div>
            </div>
            <div class="fanuc-menu d-flex flex-column w-100 pt-2 rounded align-center" :style="{backgroundColor: fanucColor2}">
              ...
              <div class="d-flex flex-column justify-space-between align-center mt-3">
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="fanucXZeroPos" class="w-100 mx-1" density="comfortable" label="X (mm)"></v-text-field>
                  <v-text-field v-model="fanucYZeroPos" class="w-100" density="comfortable" label="Y (mm)"></v-text-field>
                  <v-text-field v-model="fanucZZeroPos" class="w-100 mx-1" density="comfortable" label="Z (mm)"></v-text-field>
                </div>
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="fanucADeg" class="w-100 mx-1" density="comfortable" label="A (deg)"></v-text-field>
                  <v-text-field v-model="fanucBDeg" class="w-100" density="comfortable" label="B (deg)"></v-text-field>
                  <v-text-field v-model="fanucCDeg" class="w-100 mx-1" density="comfortable" label="C (deg)"></v-text-field>
                </div>
                <div class="d-flex align-center" style="width: 145%;">
                  <v-text-field v-model="fanucE1" class="mx-1" density="comfortable" label="E1 (deg)"></v-text-field>
                  <v-text-field v-model="fanucE2" density="comfortable" label="E2 (deg)"></v-text-field>
                </div>
              </div>
            </div>
        </div>
